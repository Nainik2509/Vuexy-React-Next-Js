...
`}</code></pre>) 
export const TextareaVariantTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
...
export default TextareaVariant
`}</code></pre>) 
export const TextareaBasicTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import Grid from '@mui/material/Grid'
import Typography from '@mui/material/Typography'
import TextareaAutosize from '@mui/material/TextareaAutosize'
