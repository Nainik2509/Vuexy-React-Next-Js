...
`}</code></pre>) 
export const TimelineCenterTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Import
import Box from '@mui/material/Box'
import List from '@mui/material/List'
import Switch from '@mui/material/Switch'
import Avatar from '@mui/material/Avatar'
...
export default TimelineCenter
`}</code></pre>) 
export const TimelineFilledTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Import
import Box from '@mui/material/Box'
import Avatar from '@mui/material/Avatar'
import Divider from '@mui/material/Divider'
import { styled } from '@mui/material/styles'
...
export default TimelineLeft
`}</code></pre>) 
export const TimelineOutlinedTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Import
import Box from '@mui/material/Box'
import Avatar from '@mui/material/Avatar'
import Divider from '@mui/material/Divider'
import { styled } from '@mui/material/styles'
