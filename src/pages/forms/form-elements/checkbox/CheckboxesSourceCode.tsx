...
const CheckboxesControlledUncontrolled: FC = () => {
  // ** State
...
const CheckboxesCustomIcons: FC = () => {
  return (
    <FormGroup row>
      <FormControlLabel
        label='Heart'
...
const CheckboxesLabelPlacement: FC = () => {
  return (
    <div>
      <FormGroup row>
        <FormControlLabel
