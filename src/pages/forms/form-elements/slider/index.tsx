...
import SliderBasic from 'src/components/forms/form-elements/slider/SliderBasic'
import SliderRange from 'src/components/forms/form-elements/slider/SliderRange'
import SliderSizes from 'src/components/forms/form-elements/slider/SliderSizes'
import SliderColors from 'src/components/forms/form-elements/slider/SliderColors'
import SliderDiscrete from 'src/components/forms/form-elements/slider/SliderDiscrete'
import SliderVertical from 'src/components/forms/form-elements/slider/SliderVertical'
import SliderSmallSteps from 'src/components/forms/form-elements/slider/SliderSmallSteps'
import SliderCustomized from 'src/components/forms/form-elements/slider/SliderCustomized'
import SliderCustomMarks from 'src/components/forms/form-elements/slider/SliderCustomMarks'
import SliderCustomColors from 'src/components/forms/form-elements/slider/SliderCustomColors'
import SliderRemovedTrack from 'src/components/forms/form-elements/slider/SliderRemovedTrack'
import SliderInvertedTrack from 'src/components/forms/form-elements/slider/SliderInvertedTrack'
import SliderMinimumDistance from 'src/components/forms/form-elements/slider/SliderMinimumDistance'
import SliderRestrictedValues from 'src/components/forms/form-elements/slider/SliderRestrictedValues'
import SliderLabelAlwaysVisible from 'src/components/forms/form-elements/slider/SliderLabelAlwaysVisible'
