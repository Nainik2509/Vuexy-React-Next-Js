export const FileUploaderRestrictionsCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
...
`}</code></pre>) 
export const FileUploaderSingleCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
...
`}</code></pre>) 
export const FileUploaderMultipleCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
