export const SliderBasicCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
...
`}</code></pre>) 
export const SliderCustomizedCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
...
`}</code></pre>) 
export const SliderControlledUncontrolledCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
...
`}</code></pre>) 
export const SliderCustomColorsCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import { styled } from '@mui/material/styles'
import Typography from '@mui/material/Typography'
import MuiSlider, { SliderProps } from '@mui/material/Slider'
...
`}</code></pre>) 
export const SliderColorsCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import Slider from '@mui/material/Slider'
import Typography from '@mui/material/Typography'
...
`}</code></pre>) 
export const SliderLabelAlwaysVisibleCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import Slider from '@mui/material/Slider'
...
`}</code></pre>) 
export const SliderCustomMarksCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import Slider from '@mui/material/Slider'
...
`}</code></pre>) 
export const SliderInvertedTrackCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import Slider from '@mui/material/Slider'
...
`}</code></pre>) 
export const SliderDiscreteCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import Slider from '@mui/material/Slider'
...
`}</code></pre>) 
export const SliderRangeCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import Slider from '@mui/material/Slider'
...
`}</code></pre>) 
export const SliderMinimumDistanceCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
import { useState } from 'react'
...
`}</code></pre>) 
export const SliderRemovedTrackCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import Slider from '@mui/material/Slider'
...
`}</code></pre>) 
export const SliderSizesCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import Slider from '@mui/material/Slider'
import Typography from '@mui/material/Typography'
...
`}</code></pre>) 
export const SliderRestrictedValuesCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import Slider from '@mui/material/Slider'
...
`}</code></pre>) 
export const SliderSmallStepsCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import Slider from '@mui/material/Slider'
...
`}</code></pre>) 
export const SliderVerticalCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
