export const TextareaVariantCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
...
`}</code></pre>) 
export const TextareaBasicCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
