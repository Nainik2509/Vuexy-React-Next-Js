export const TextFieldColorCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
...
`}</code></pre>) 
export const TextFieldComponentsCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
...
`}</code></pre>) 
export const TextFieldControlledUncontrolledCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
import { ChangeEvent, useState } from 'react'
...
`}</code></pre>) 
export const TextFieldCustomizedCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import InputLabel from '@mui/material/InputLabel'
import FormControl from '@mui/material/FormControl'
...
`}</code></pre>) 
export const TextFieldInputAdornmentCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
...
`}</code></pre>) 
export const TextFieldFormPropsCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import TextField from '@mui/material/TextField'
...
`}</code></pre>) 
export const TextFieldInputsCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import Input from '@mui/material/Input'
...
`}</code></pre>) 
export const TextFieldLayoutCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
...
`}</code></pre>) 
export const TextFieldIconsCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
...
`}</code></pre>) 
export const TextFieldSizesCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import TextField from '@mui/material/TextField'
...
`}</code></pre>) 
export const TextFieldVariantCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import TextField from '@mui/material/TextField'
...
`}</code></pre>) 
export const TextFieldValidationCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import TextField from '@mui/material/TextField'
