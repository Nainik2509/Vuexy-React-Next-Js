export const TimelineFilledJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** Next Import
...
`}</code></pre>) 
export const TimelineCenterJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** Next Import
import Image from 'next/image'
...
`}</code></pre>) 
export const TimelineOutlinedJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** Next Import
import Image from 'next/image'
...
`}</code></pre>) 
export const TimelineCenterTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** Next Import
import Image from 'next/image'
...
export default TimelineCenter
`}</code></pre>) 
export const TimelineFilledTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** Next Import
import Image from 'next/image'
...
export default TimelineLeft
`}</code></pre>) 
export const TimelineOutlinedTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** Next Import
import Image from 'next/image'
