export const TimelineCenterCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** Next Import
...
`}</code></pre>) 
export const TimelineFilledCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** Next Import
import Image from 'next/image'
...
`}</code></pre>) 
export const TimelineOutlinedCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** Next Import
import Image from 'next/image'
