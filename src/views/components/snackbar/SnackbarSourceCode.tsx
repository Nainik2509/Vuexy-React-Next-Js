export const SnackbarConsecutiveCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
...
`}</code></pre>) 
export const SnackbarControlSlideDirectionCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
...
`}</code></pre>) 
export const SnackbarAlertCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
...
`}</code></pre>) 
export const SnackbarPositionedCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
...
`}</code></pre>) 
export const SnackbarTransitionCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
...
`}</code></pre>) 
export const SnackbarSimpleCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
import { Fragment, SyntheticEvent, useState } from 'react'
