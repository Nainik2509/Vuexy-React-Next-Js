...
`}</code></pre>) 
export const ButtonGroupBasicTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import Button from '@mui/material/Button'
import ButtonGroup from '@mui/material/ButtonGroup'
...
export default ButtonGroupBasic
`}</code></pre>) 
export const ButtonGroupSizesTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import Button from '@mui/material/Button'
import ButtonGroup from '@mui/material/ButtonGroup'
...
export default ButtonGroupSizes
`}</code></pre>) 
export const ButtonGroupColorsTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import Button from '@mui/material/Button'
import ButtonGroup from '@mui/material/ButtonGroup'
...
export default ButtonGroupColor
`}</code></pre>) 
export const ButtonGroupSplitTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
...
export default ButtonGroupSplit
`}</code></pre>) 
export const ButtonGroupVerticalTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import Button from '@mui/material/Button'
import ButtonGroup from '@mui/material/ButtonGroup'
...
export default ButtonGroupVertical
`}</code></pre>) 
export const ButtonToggleColorsTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
...
export default ButtonToggleColors
`}</code></pre>) 
export const ButtonToggleEnforceValueTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
import { MouseEvent, useState } from 'react'
...
export default ButtonToggleEnforceValue
`}</code></pre>) 
export const ButtonToggleCustomizedTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
import { MouseEvent, useState } from 'react'
...
export default ButtonToggleCustomized
`}</code></pre>) 
export const ButtonToggleMultipleTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
import { MouseEvent, useState } from 'react'
...
export default ButtonToggleMultiple
`}</code></pre>) 
export const ButtonToggleSizesTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
import { MouseEvent, useState } from 'react'
...
export default ButtonToggleSizes
`}</code></pre>) 
export const ButtonToggleSimpleTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
import { MouseEvent, useState } from 'react'
...
export default ButtonToggleSimple
`}</code></pre>) 
export const ButtonToggleVerticalTSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
import { MouseEvent, useState } from 'react'
