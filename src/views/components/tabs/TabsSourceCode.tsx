export const TabsCenteredCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
...
`}</code></pre>) 
export const TabsCustomizedVerticalCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
import { SyntheticEvent, useState } from 'react'
...
`}</code></pre>) 
export const TabsForcedScrollCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
import { SyntheticEvent, useState } from 'react'
...
`}</code></pre>) 
export const TabsCustomizedCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
import { SyntheticEvent, useState } from 'react'
...
`}</code></pre>) 
export const TabsNavCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
...
`}</code></pre>) 
export const TabsFullWidthCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
import { SyntheticEvent, useState } from 'react'
...
`}</code></pre>) 
export const TabsColorCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
import { SyntheticEvent, useState } from 'react'
...
`}</code></pre>) 
export const TabsIconCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
import { SyntheticEvent, useState } from 'react'
...
`}</code></pre>) 
export const TabsVerticalCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
import { SyntheticEvent, useState } from 'react'
...
`}</code></pre>) 
export const TabsSimpleCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** React Imports
import { SyntheticEvent, useState } from 'react'
