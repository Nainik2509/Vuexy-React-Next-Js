...
`}</code></pre>) 
export const ToastPositionsJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
...
const ToastPositions = ({ activePosition, setActivePosition }) => {
  const handleToast = async (position, text) => {
...
`}</code></pre>) 
export const ToastTypesJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`// ** MUI Imports
import Box from '@mui/material/Box'
import Card from '@mui/material/Card'
import Button from '@mui/material/Button'
import Avatar from '@mui/material/Avatar'
