...
// ** Tab Content Imports
import DialogTabDetails from 'src/components/pages/dialog-examples/create-app-tabs/DialogTabDetails'
import DialogTabBilling from 'src/components/pages/dialog-examples/create-app-tabs/DialogTabBilling'
import DialogTabDatabase from 'src/components/pages/dialog-examples/create-app-tabs/DialogTabDatabase'
import DialogTabFramework from 'src/components/pages/dialog-examples/create-app-tabs/DialogTabFramework'
