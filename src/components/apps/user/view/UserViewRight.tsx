...
import UserViewBilling from 'src/components/apps/user/view/UserViewBilling'
import UserViewOverview from 'src/components/apps/user/view/UserViewOverview'
import UserViewSecurity from 'src/components/apps/user/view/UserViewSecurity'
import UserViewConnection from 'src/components/apps/user/view/UserViewConnection'
import UserViewNotification from 'src/components/apps/user/view/UserViewNotification'
